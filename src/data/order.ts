...
/**
 * 카드 스캔(OCR)으로 읽어낸 값 — 카드 정보 확인 시트(1742:54183)에 뜹니다.
 * 실제 OCR 결과가 아니라 인식된 것처럼 보여주는 고정값입니다.
 * 디자인은 `1234 - 1234 - 1234 - 1234` / `12 / 30`이었고,
 * 2026-07-29 이재이가 실제 확인용 값으로 바꿔달라고 해서 아래 값으로 뒀습니다.
 */
export const SCANNED_CARD = {
  number: '4788 - 9200 - 1328 - 5829',
  expiry: '09 / 28',
}
